...
return {
    {
        ...
        keys = {
            ...
            { "<leader>xn", function() vim.diagnostic.jump({ count = 1, float = true }) end, desc = "Next Error/Diagnostic" },
            { "<leader>xp", function() vim.diagnostic.jump({ count = -1, float = true }) end, desc = "Previous Error/Diagnostic" },
        },
        opts = {},
    },
}
