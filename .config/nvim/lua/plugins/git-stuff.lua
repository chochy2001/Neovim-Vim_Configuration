return {
    ...
    -- GitSigns: Hunk operations and stage/reset
    {
        ...
        config = function()
            ...
            vim.keymap.set(
                ...
                "<leader>gsa",
                gs.stage_hunk,
                vim.tbl_extend("force", opts, { desc = "Git: Stage Add (hunk)" })
            )
            vim.keymap.set(
                "n",
                "<leader>gsr",
                gs.reset_hunk,
                vim.tbl_extend("force", opts, { desc = "Git: Stage Reset (hunk)" })
            )
            vim.keymap.set(
                "n",
                "<leader>gsu",
                gs.stage_hunk,
                vim.tbl_extend("force", opts, { desc = "Git: Toggle Stage (hunk)" })
            )
            vim.keymap.set(
                "n",
                "<leader>gsp",
                gs.preview_hunk,
                vim.tbl_extend("force", opts, { desc = "Git: Stage Preview" })
            )
            vim.keymap.set(
                "n",
                "<leader>gsb",
                gs.reset_buffer,
                vim.tbl_extend("force", opts, { desc = "Git: Stage Buffer reset" })
            )
            ...
            vim.keymap.set(
                ...
                "<leader>gdl",
                gs.diffthis,
                vim.tbl_extend("force", opts, { desc = "Git: Diff Local changes" })
            )
            ...
            vim.keymap.set(
                ...
                vim.tbl_extend("force", opts, { desc = "Git: Blame Toggle inline" })
            )
    ...
    -- Git Conflict: Merge conflict resolution
    {
        ...
        config = function()
            require("compat.git-conflict").load().setup({
