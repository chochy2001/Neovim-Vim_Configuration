...
return {
    {
        ...
        keys = {
            ...
            },
            {
                "<leader>ag",
                function()
                    require("ai-terminals").toggle("gemini")
                end,
                desc = "AI: gemini",
            },
            {
                "<leader>ak",
                function()
                    require("ai-terminals").toggle("grok")
                end,
                desc = "AI: grok",
            },
            {
                "<leader>ap",
                function()
                    require("ai-terminals").toggle("copilot")
                end,
                desc = "AI: copilot CLI",
            },
            ...
            -- and the selection is sent to it (prompt also kept in clipboard)
            {
                "<leader>as",
                function()
                    require("ai-terminals").send_visual_pick()
                end,
                mode = "x",
                desc = "AI: prepare selection (pick agent)",
            },
        },
    },
}
