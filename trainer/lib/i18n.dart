class T {
  ...
  String get importFolder =>
      es ? 'Abrir carpeta del proyecto' : 'Open project folder';
  ...
  String get importFail => es
      ? 'No se leyeron archivos de código (límite 40, 12 KB, sin node_modules/.git).'
      : 'No code files read (cap 40 files, 12 KB, skips node_modules/.git).';
